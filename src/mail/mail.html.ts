...
export const htmlSendCodeMail = (code: string) => {
  const baseUrl = process.env.BASE_URL;
  ...
  <div style="max-width: 600px; margin: auto; background-color: white; border-radius: 12px; padding: 30px; box-shadow: 0 4px 14px rgba(0,0,0,0.1);">
    ...
    <p style="font-size: 16px; color: #4b5563; margin-bottom: 20px;">
      Pour finaliser la vérification de votre adresse email, veuillez utiliser le code ci-dessous. Ce code est confidentiel et expire dans <strong>2 minutes</strong>.
    </p>
    ...
    <p style="font-size: 13px; color: #6b7280; margin-bottom: 10px;">
      Si vous n'avez pas demandé à vérifier votre adresse email, veuillez ignorer ce message. Aucun changement ne sera effectué sans votre confirmation.
    </p>
